              ...
              <div className="container-xxl flex-grow-1 container-p-y">
                ...
                {Type == "SearchForm" ? (
                      ...
                      <div className="authentication-inner py-6 mx-4">
                        <div className="card p-7">
                          ...
                          <div className="card-body">
                            ...
                            <p className="mb-5">
                              Please Enter Order Number to Fetch Data
                            </p>
                            <form
                  ...
                  <div className="container col-md-10 m-auto mt-2">
                    <h3 className="text-center text-primary">CARTING LCL</h3>
                    <form action="" onSubmit={handleFormSubmit}>
                                  ...
                                  <div className="col-md-6 col-sm-6 mb-2">
                                    <div className="form-floating form-floating-outline">
                                      <input
                                        ...
                                        disabled={DisAbled}
                                      />
                                      <label htmlFor={`area_${Details["id"]}`}>
                                        Area
                                      </label>
                                    </div>
                                  </div>
                      ...
                      <div className="row">
                        <div className="col-md-4 mt-2">
                          {/* {ReadOnly ? (<button type="button" onClick={()=>setType("ShowTable")} className="btn btn-dark">
                            Next
                          </button>): (<button type="submit" className="btn btn-dark">
                           Next & Submit
                          </button>)}  */}
