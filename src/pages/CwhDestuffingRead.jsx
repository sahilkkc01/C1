...
import TallySheetDeStuffingFCL from "./TallySheetDeStuffingFCL";
import Header from "./main/header";
import { formatToDateTimeLocal } from "./main/formatToDateTime";

export default function CWHDestuffingRead() {
              ...
              <div className="row">
                ...
                {Type == "SearchForm" ? (
                  ...
                  <div className="container col-md-10 m-auto mt-2">
                    <h4 className="text-center text-primary">DeStuffing FCL</h4>
                  ...
                  <div className="col-md-11 m-auto">
                    ...
                    >
                      <iframe
                        ref={iframeRef}
                        src={`/TallySheetDeStuffingFCL/${Data["container_number"]}`}
                        style={{
                          width: "100%",
                          height: "100%",
                    ...
                    {/* <TallySheetDeStuffingFCL Data={Data} /> */}
                  </div>
                )}
</div>
                <Footer />
